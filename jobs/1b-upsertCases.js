    ...
    const mappingSpecForPLH = [
      ...
      },
      {
        source: {
          ...
          //'1. การจับตัวเด็กเขย่า: ในสัปดาห์ที่ผ่านมานี้ [[(ชื่อผู้ดูแลหลักของเด็ก):careGiverFullName]] จับตัว [[(ชื่อเด็ก):caseFullName]] เขย่ากี่ครั้ง?' || '1. การจับตัวเด็กเขย่า: ในสัปดาห์ที่ผ่านมานี้ (ชื่อผู้ดูแลหลักของเด็ก) จับตัว(ชื่อเด็ก)เขย่ากี่ครั้ง?',
        },
        destination: {
          type: 'varchar',
